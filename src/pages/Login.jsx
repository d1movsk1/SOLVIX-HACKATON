...
export default function Login() {
  ...
  // Ако веќе е логиран — препрати на почетна
  useEffect(() => {
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-parchment-3 rounded-3xl p-8 shadow-lift flex flex-col gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-base text-ink-muted">
                Регистрирај се или влези со твојот Google account
              </p>
            </div>
            ...
            <button
              onClick={login}
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-parchment-3
                         hover:border-ink-soft hover:bg-parchment-2 transition-all rounded-2xl py-4 px-6
                         text-ink font-semibold text-base shadow-card"
            >
              {/* Google SVG икона */}
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 h-px bg-parchment-3" />
              <span className="text-sm text-ink-muted">или</span>
              <div className="flex-1 h-px bg-parchment-3" />
            </div>
