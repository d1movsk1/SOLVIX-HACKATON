...
export default function Home() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 pb-20">
      {/* Hero */}
      <section className="py-16 sm:py-20 max-w-lg">
        <p className="section-eyebrow">Аукции на блокчејн</p>
        <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-medium leading-[1.05] text-ink mb-4">
          Секој предмет
          <br />
          <em className="italic text-gold">носи приказна.</em>
        </h1>
        <p className="text-base sm:text-lg font-light text-ink-soft leading-relaxed max-w-sm">
          Автентични рачно изработени предмети од Македонија. Секоја продажба
          верифицирана со NFT на Solana.
        </p>
      </section>
      ...
      <div
        className={`${showFilters ? "flex" : "hidden sm:flex"} flex-col sm:flex-row gap-3 mb-6`}
      >
